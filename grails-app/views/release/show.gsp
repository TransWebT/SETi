	...
	<body>
		...
		<div id="show-release" class="content scaffold-show" role="main">
			...
			<ol class="property-list release">
				...
				<g:if test="${releaseInstance?.displayOrder}">
				<li class="fieldcontain">
					<span id="displayOrder-label" class="property-label"><g:message code="release.displayOrder.label" default="Display Order" /></span>
					
						<span class="property-value" aria-labelledby="displayOrder-label"><g:fieldValue bean="${releaseInstance}" field="displayOrder"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${releaseInstance?.modifiedBy}">
				<li class="fieldcontain">
					<span id="modifiedBy-label" class="property-label"><g:message code="release.modifiedBy.label" default="Modified By" /></span>
					
						<span class="property-value" aria-labelledby="modifiedBy-label"><g:link controller="user" action="show" id="${releaseInstance?.modifiedBy?.id}">${releaseInstance?.modifiedBy?.encodeAsHTML()}</g:link></span>
				...
				<g:if test="${releaseInstance?.lastUpdated}">
				<li class="fieldcontain">
					<span id="lastUpdated-label" class="property-label"><g:message code="release.lastUpdated.label" default="Last Updated" /></span>
					
						<span class="property-value" aria-labelledby="lastUpdated-label"><g:formatDate date="${releaseInstance?.lastUpdated}" /></span>
