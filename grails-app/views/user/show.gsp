	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="modifiedBy-label" class="property-label"><g:message code="user.modifiedBy.label" default="Modified By" /></span>
					
						<span class="property-value" aria-labelledby="modifiedBy-label"><g:link controller="user" action="show" id="${userInstance?.modifiedBy?.id}">${userInstance?.modifiedBy?.encodeAsHTML()}</g:link></span>
